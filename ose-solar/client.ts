namespace opensciedModules {
    //% fixedInstances
    export class OpensciedSolarClient extends modules.LightLevelClient {
        ...
        //% blockId=openscied_solar_get_light_level
        //% weight=100
        lightLevel(): number {
        ...
        //% blockId=openscied_solar_is_past_threshold
    ...
    export const solar1 = new OpensciedSolarClient("solar1")
    //% fixedInstance whenUsed
    export const solar2 = new OpensciedSolarClient("solar2")
    //% fixedInstance whenUsed
    export const solar3 = new OpensciedSolarClient("solar3")
    //% fixedInstance whenUsed
    export const solar4 = new OpensciedSolarClient("solar4")
}
